---
title: "Assignment 3 - Language Development in ASD - Power and simulations"
author: "[YOUR NAME]"
date: "[DATE]"
...
# Assessing power 
power_int <- powerSim((m1), fixed("Diagnosis:VISIT"), nsim = 100)

print(power_int)

# Testing how many participants are required to replicate the findings
pc1 <- powerCurve((m1), fixed("Diagnosis:VISIT"), nsim = 100, along = "ID")
...
# Assessing power 
power_vIQ <- powerSim((m1), fixed("vIQ1"), nsim = 100)

print(power_vIQ)

# Testing how many participants are required to replicate the findings
pc1_v <- powerCurve((m1), fixed("vIQ1"), nsim = 100, along = "ID")
...
power_int_new <- powerSim((m2), fixed("Diagnosis:VISIT"), nsim = 100)
...
# Assessing power
power_int_30 <- powerSim((m_30p), fixed("Diagnosis:VISIT"), nsim = 100)
